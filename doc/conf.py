# -*- coding: utf-8 -*-
#
# InfiniSDK documentation build configuration file, created by
...
from infinisdk.core.utils.packaging_metadata import get_distribution_version
...
version = release = get_distribution_version('infinisdk')
...
htmlhelp_basename = 'InfiniSDKdoc'
...
man_pages = [
    ('index', 'infinisdk', u'InfiniSDK Documentation', [u'Infinidat'], 1)
]
