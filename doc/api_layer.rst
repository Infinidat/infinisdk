...
InfiniSDK contains an API abstraction layer intended to ease the process of talking to the Infinidat API protocol.

.. automodule:: infinisdk.core.api

.. autoclass:: infinisdk.core.api.API
   :members:
...
.. autoclass:: infinisdk.core.api.APITarget
   :members:
...
In scripting tasks this is less critical, and it is assumed that it is better to let the script run interrupted than to raise an exception in such cases. InfiniSDK, therefore, always sends commands as "approved".
