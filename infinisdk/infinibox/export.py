...
class Export(InfiniBoxObject):
    FIELDS = [
        ...
        _Field(
            ...
            default=Autogenerate("/{prefix}export_{uuid}"),
        ),
        ...
        _Field(
            "enabled", type=bool, mutable=True, creation_parameter=True, optional=True
        ),
        _Field(
            "make_all_users_anonymous",
            type=bool,
            mutable=True,
            creation_parameter=True,
            optional=True,
        ...
        _Field(
            "transport_protocols", creation_parameter=True, optional=True, mutable=True
        ),
        _Field(
            "32bit_file_id",
            type=bool,
