...
class Host(InfiniBoxLURelatedObject):
    ...
    FIELDS = [
        ...
        Field("san_client_type", new_to="3.0", is_filterable=True),
        ...
        Field("security_chap_outbound_username", creation_parameter=True, feature_name='iscsi', optional=True, mutable=True),
