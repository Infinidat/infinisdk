...
class Host(InfiniBoxLURelatedObject):
    ...
    FIELDS = [
        ...
        Field("security_chap_inbound_username", creation_parameter=True, optional=True, mutable=True),
        Field("security_chap_inbound_secret", creation_parameter=True, add_getter=False, optional=True, mutable=True),
        Field("security_chap_has_inbound_secret", type=bool),
        Field("security_chap_outbound_username", creation_parameter=True, optional=True, mutable=True),
        Field("security_chap_outbound_secret", creation_parameter=True, add_getter=False, optional=True, mutable=True),
        Field("security_chap_has_outbound_secret", type=bool),
