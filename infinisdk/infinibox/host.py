...
class Host(InfiniBoxLURelatedObject):
    ...
    FIELDS = [
        ...
        Field("security_chap_inbound_username", creation_parameter=True, feature_name='iscsi', optional=True, mutable=True, is_sortable=True, is_filterable=True),
        ...
        Field("security_chap_outbound_username", creation_parameter=True, feature_name='iscsi', optional=True, mutable=True, is_sortable=True, is_filterable=True),
        Field("security_chap_outbound_secret", creation_parameter=True, feature_name='iscsi', add_getter=False, optional=True, mutable=True),
