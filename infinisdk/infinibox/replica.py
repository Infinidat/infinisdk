...
class Replica(SystemObject):
    ...
    FIELDS = [
        ...
        Field('remote_pool_id', type=int, creation_parameter=True, optional=True, is_filterable=True, cached=True),
        ...
        Field('local_pool_id', type=int, is_filterable=True, cached=True),
